...
const ShareableCard = forwardRef(function ShareableCard({ dayData, dateStr, activeDays, daysInMonth }, ref) {
  ...
  return (
    ...
    >
      <div style={{ position: "absolute", top: -30, right: -30, width: 120, height: 120, borderRadius: "50%", background: t.decorA }} />
      ...
      {activeActs.length > 0 ? (
        ...
        <div style={{ textAlign: "center", marginBottom: 18, fontSize: 13, color: t.textSub }}>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: dayData.note ? 14 : 0 }}>
        ...
        {activeDays != null && daysInMonth != null && (
          <div style={{ flex: 1, background: t.statBg, borderRadius: 12, padding: "10px 8px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: 9, fontWeight: 600, color: t.textSub, textTransform: "uppercase", letterSpacing: 0.5 }}>This Month</div>
          </div>
        )}
        <div style={{ flex: 1, background: t.statBg, borderRadius: 12, padding: "10px 8px", textAlign: "center" }}>
      ...
      {dayData.note && (
        <div style={{ background: t.noteBg, borderRadius: 10, padding: "8px 12px", marginTop: 4 }}>
          <div style={{ fontSize: 11, color: t.noteText, fontStyle: "italic" }}>
            📝 {dayData.note}
          </div>
        </div>
      )}
